    ...
    while running:
        if part_window == 0:
            ...
            if len(sprite_enemy) == 0:
                if count_finish == 0:
                    count_finish += 1
                    Enemy((20, 20), (50, 50), 10)
                    Enemy((890, 20), (50, 50), 15)
            ...
            if result == 'win':
                ...
                screen.blit(font.render('Нажмите на любое место', True, pygame.Color('red')), (170, 595))
        pygame.display.flip()
        clock.tick(100)
    f.close()
    pygame.quit()
